...
REM set SDVERSION=0xb6
REM set SOFTDEVICE=%SDK%\components\softdevice\s140\hex\s140_nrf52_6.1.1_softdevice.hex

REM nRF52832
set FAMILY=NRF52
set HWVERSION=52
set SDVERSION=0xb7
set SOFTDEVICE=%SDK%\components\softdevice\s132\hex\s132_nrf52_6.1.1_softdevice.hex

REM set your app/bl path (nRF52840)
REM set APP=..\application\pca10056\s140\ses\Output\Release\Exe\ble_app_buttonless_dfu_pca10056_s140.hex
REM set BOOTLOADER=..\bootloader\pca10056_ble\ses\Output\Release\Exe\secure_bootloader_ble_s140_pca10056.hex

REM set your app/bl path (nRF52832)
set APP=..\application\pca10040\s132\ses\Output\Release\Exe\ble_app_buttonless_dfu_pca10040_s132.hex
set BOOTLOADER=..\bootloader\pca10040_ble\ses\Output\Release\Exe\secure_bootloader_ble_s132_pca10040.hex
